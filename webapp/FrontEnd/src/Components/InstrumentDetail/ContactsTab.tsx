            ...
            <Table stickyHeader sx={{ minWidth: '35vw' }} aria-label="simple table">
                ...
                <TableBody>
                    {contacts && contacts.map((row) => (
                        ...
                        >
                            <TableCell align="center" component="th" scope="row"><Link href={"https://dev.mri.psu.edu/mri/personnel-directory/" + row?.email.replace("@psu.edu","")} target="_blank"  rel="noopener"><Typography variant="body2" gutterBottom component="div">{row?.firstName} {row?.middleName} {row?.lastName}</Typography></Link></TableCell>
